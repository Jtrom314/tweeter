...
import { UserRegisterPresenter, UserRegisterView } from "../../../presenter/UserRegisterPresenter";
...
const Register = () => {
  ...
  const listener: UserRegisterView = {
  ...
  const inputFieldGenerator = () => {
    return (
      <>
        ...
        <AuthenticationFields setAlias={setAlias} setPassword={setPassword} authenticationAction={registerOnEnter}/>
